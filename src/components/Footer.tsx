        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Empowering creators with AI-powered image generation. Transform your ideas into stunning visuals in seconds.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="max-w-md">
            ...
            <div className="flex space-x-4">
              ...
              />
              <button className="bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 px-6 py-2 rounded-lg font-medium transition-colors">
                Subscribe
              </button>
            </div>
          </div>
